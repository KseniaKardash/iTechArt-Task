...
<<<<<<< HEAD
  const validatedName = validateName(formName) ? isCorrect(wrongName) : isWrong(wrongName);
  const validatedEmail = validateEmail(formEmail) ? isCorrect(wrongEmail) : isWrong(wrongEmail);
  const generalValidation = (validatedEmail && validatedName);
=======
...
>>>>>>> a9958165c93fd9d606b76b5133d6288c0379028e
